		...
		<div className='h-screen flex justify-center' onLoad={generator}>
			<div className='h-full w-full md:w-6/12'>
				...
				<div className='bg-slate-100 mt-8 md:mt-8 p-6 md:mx-10 md:w-909'>
					...
					Welcome Onboard! You have successfully registered for FCS SOD 2022. Please save your ID card on your device and come along with it when school commences. See you shortly. Glory!
					</p>
				</div>
				...
				<div className='p-6 md:mx-10 md:px-0'>
					...
					>
						<div className='px-3 md:px-6 '>
							<p className='font-slabo text-base md:text-base md:mb-1 px-2 border-b border-slate-300 font-medium mb-2 pb-2'>{profile.fName}</p>
							{/* <p className='font-slabo text-base md:text-base md:mb-1'>{profile.sodDept}</p> */}
							<p className='font-slabo text-sm md:text-base md:mb-1 bg-slate-100 rounded-sm w-fit'>A Genearation of Glory</p>
