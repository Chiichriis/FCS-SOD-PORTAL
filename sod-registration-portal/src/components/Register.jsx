				...
				<div className='bg-white min-h-full rounded drop-shadow-lg flex justify-center px-4 py-4 md:w-11/12'>
					<div className='container bg-inherit flex flex-col items-center pt-2'>
						...
						<form onSubmit={handleSubmit(onRegister)} className='mt-10 md:mt-6 w-full p-2'>
							...
							>
								<option value=''></option>
								<option value='BT'>Biblical Theology and Ecumenism (BTE)</option>
								<option value='EA'>Erudition and Academic Exploits (EAE)</option>
								<option value='WI'>Wealth and Influence (WIN)</option>
								<option value='FL'>Family Life and Relationship (FLR)</option>
								<option value='ID'>Identity and Dominion (IDO)</option>
								<option value='LC'>Leadership and Culture (LCU)</option>
								<option value='AR'>Arts and Entertainment (ART)</option>
								<option value='MS'>Missions and Apologetics (MSA)</option>
								<option value='FA'>Faith and the supernatural (FAS)</option>
							</select>
							<div className='md:w-96 pb-3 text-xs text-red-600 italic'>
